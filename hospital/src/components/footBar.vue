<template>
  <div class='footer'>
    <div @click="changTab(0)" class="item">
      ...
      <p :class="selIndex === 0?'sel':''" class="text">酒店预订</p>
    ...
    <div @click="changTab(1)" class="item">
      ...
      <p :class="selIndex === 1?'sel':'' " class="text">店内服务</p>
    </div>
    <div @click="changTab(2)" class="item mine">
      <img src="../assets/tabbar/me_sel.png" class='icon-footer' v-if="selIndex === 2">
      <img src="../assets/tabbar/me.png" class='icon-footer' v-else>
      <p :class="selIndex === 2?'sel':'' " class="text">我的</p>
    </div>
  </div>
</template>
<script>
